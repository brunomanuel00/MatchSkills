    ...
    return (
        <>
            <div className="min-h-screen pt-20 p-4 bg-gradient-to-br from-tea_green-500 to-light_green-300 dark:from-lapis_lazuli-500 dark:to-verdigris-700">
                ...
                <div className="mx-auto w-full max-w-[1600px] px-2"> {/* Reducimos el max-width y agregamos padding horizontal */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-6 gap-2 md:gap-3 justify-items-center"> {/* Ajustamos el gap */}
                        {matches?.map((item) => (
